// agrotrust-az/src/pages/marketing/Home.tsx
 ...
 *
 * Hackathon MVP copy is intentionally concise but credible.
 */
  ...
  return (
    <div className="container">
      <section className="home-hero">
        <div className="home-hero__content">
          ...
          <p className="home-hero__subtitle">
            {BRAND.tagline}. Empowering Azerbaijani cooperatives to export with
            confidence through digital traceability and inspection-gated
            escrow.
          </p>
        ...
        <div className="home-hero__card card card--soft">
          ...
          <ul className="home-list">
            <li>
              Small farmers struggle to prove origin, input usage, and harvest
              freshness to sophisticated buyers.
            </li>
            <li>
              Export opportunities are often lost to intermediaries with high
              margins.
            </li>
            <li>
          ...
          <ol className="home-list">
            ...
            <li>
              Escrow funds held and released after border inspection (MVP
              simulation).
            </li>
          </ol>
        </div>
      ...
      <section className="home-section">
        <header className="home-section__header">
          ...
          <p className="home-section__subtitle muted">
            A simple system that demonstrates a future-ready standard for
            traceability and compliance without overwhelming smaller producers.
          </p>
        </header>
        ...
        <div className="home-grid">
          <div className="card">
            ...
            <p className="muted">
              Capture harvest dates, fertiliser declarations, and evidence
              photos in a consistent lot model. The goal is clarity for buyers
              and confidence for border inspection.
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="muted">
              Each lot can generate a QR payload that a buyer can verify
              instantly. In the hackathon MVP, verification is powered by
              Netlify Functions.
            </p>
          </div>
          ...
          <div className="card">
            ...
            <p className="muted">
              Escrow reduces risk for both sides. Buyers know funds are only
              released on inspection pass; farmers gain a credible path to
              direct export.
            </p>
          </div>
        </div>
      ...
      <section className="home-section">
        <div className="card home-highlight">
          <div className="home-highlight__content">
            ...
            <p className="muted">
              AgroTrust AZ is designed to scale across cooperatives and foreign
              procurement teams with a shared language of quality evidence and
      ...
      <section className="home-section home-cta">
        ...
        <p className="muted">
          Create a cooperative account, explore sample lots, and generate a
          Digital Product Passport in minutes.
        </p>
      ...
      {/* Page-scoped styles: keeps the MVP moving without requiring a CSS framework */}
      <style>
        {`
          .home-hero{
            display:grid;
